 ...
 * @author sf_domingo
 */
public class Scroll2 extends StaticBody implements SensorListener{
    
    private static final BodyImage scrollOpen = new BodyImage("data/scrolltext2.png", 12.0f);
    private static final BodyImage scrollClose = new BodyImage("data/Boots-scroll.png", 2.0f);

    public Scroll2(World world, GonzaloCharacter gonzalo) {
        super(world);
